...
class Merchant(models.Model):
    ...
    商家
    """
    name = models.CharField(max_length=200,verbose_name='商家名称',null=False) # null 和 blank 默认为 False
    ...
    up_send = models.DecimalField(verbose_name='起送价',default=0,max_digits=6,decimal_places=2, null=False)
    lon = models.FloatField(verbose_name='经度', null=True, blank=True)
...
class Goods(models.Model):
    ...
    category = models.ForeignKey('meituan.GoodsCategory', on_delete=models.CASCADE, related_name='goods_list')
